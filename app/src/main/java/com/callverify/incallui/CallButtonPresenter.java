...
import com.callverify.incallui.InCallCameraManager.Listener;
...
public class CallButtonPresenter extends Presenter<CallButtonPresenter.CallButtonUi>
        ...
        InCallPresenter.InCallDetailsListener, InCallPresenter.CanAddCallListener, Listener {
    ...
    private void updateButtonsState(Call call) {
        ...
        ui.showButton(CallButtonFragment.Buttons.BUTTON_AUDIO, true);
        ui.showButton(CallButtonFragment.Buttons.BUTTON_SWAP, showSwap);
        ui.showButton(CallButtonFragment.Buttons.BUTTON_HOLD, showHold);
        ui.setHold(isCallOnHold);
        ui.showButton(CallButtonFragment.Buttons.BUTTON_MUTE, showMute);
        ui.showButton(CallButtonFragment.Buttons.BUTTON_ADD_CALL, showAddCall);
        ui.showButton(CallButtonFragment.Buttons.BUTTON_UPGRADE_TO_VIDEO, showUpgradeToVideo);
        ui.showButton(CallButtonFragment.Buttons.BUTTON_SWITCH_CAMERA, isVideo);
        ui.showButton(CallButtonFragment.Buttons.BUTTON_PAUSE_VIDEO, isVideo);
        ui.showButton(CallButtonFragment.Buttons.BUTTON_DIALPAD, !isVideo);
        ui.showButton(CallButtonFragment.Buttons.BUTTON_MERGE, showMerge);
