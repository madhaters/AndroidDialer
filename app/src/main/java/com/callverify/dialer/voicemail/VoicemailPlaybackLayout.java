...
package com.callverify.dialer.voicemail;
...
import com.callverify.dialer.util.AsyncTaskExecutor;
import com.callverify.dialer.util.AsyncTaskExecutors;
        ...
        mAsyncTaskExecutor.submit(Tasks.QUERY_ARCHIVED_STATUS,
                new AsyncTask<Void, Void, Boolean>() {
                    ...
                    public Boolean doInBackground(Void... params) {
                        Cursor cursor = mContext.getContentResolver().query(VoicemailArchiveContract.VoicemailArchive.CONTENT_URI,
                                null, VoicemailArchiveContract.VoicemailArchive.SERVER_ID + "=" + ContentUris.parseId(mVoicemailUri)
                                        + " AND " + VoicemailArchiveContract.VoicemailArchive.ARCHIVED + "= 1", null, null);
