...
package com.callverify.dialer.database;
...
import com.callverify.contacts.common.compat.CompatUtils;
import com.callverify.contacts.common.util.PermissionsUtil;
import com.callverify.contacts.common.util.StopWatch;
import com.callverify.dialer.R;
import com.callverify.dialer.dialpad.SmartDialNameMatcher;
import com.callverify.dialer.dialpad.SmartDialPrefix;
...
public class DialerDatabaseHelper extends SQLiteOpenHelper {
     ...
     */
    private static final String DATABASE_LAST_CREATED_SHARED_PREF = "";
    ...
    public static final Uri SMART_DIAL_UPDATED_URI =
            Uri.parse("content:///smart_dial_updated");
    ...
    private void setupTables(SQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE " + Tables.FILTERED_NUMBER_TABLE + " ("
                + FilteredNumberContract.FilteredNumberColumns._ID + " INTEGER PRIMARY KEY AUTOINCREMENT,"
                + FilteredNumberContract.FilteredNumberColumns.NORMALIZED_NUMBER + " TEXT UNIQUE,"
                + FilteredNumberContract.FilteredNumberColumns.NUMBER + " TEXT,"
                + FilteredNumberContract.FilteredNumberColumns.COUNTRY_ISO + " TEXT,"
                + FilteredNumberContract.FilteredNumberColumns.TIMES_FILTERED + " INTEGER,"
                + FilteredNumberContract.FilteredNumberColumns.LAST_TIME_FILTERED + " LONG,"
                + FilteredNumberContract.FilteredNumberColumns.CREATION_TIME + " LONG,"
                + FilteredNumberContract.FilteredNumberColumns.TYPE + " INTEGER,"
                + FilteredNumberContract.FilteredNumberColumns.SOURCE + " INTEGER"
                + ");");
    ...
    private void createVoicemailArchiveTable(SQLiteDatabase db) {
        db.execSQL("CREATE TABLE " + Tables.VOICEMAIL_ARCHIVE_TABLE + " ("
                + VoicemailArchiveContract.VoicemailArchive._ID + " INTEGER PRIMARY KEY AUTOINCREMENT,"
                + VoicemailArchiveContract.VoicemailArchive.NUMBER + " TEXT,"
                + VoicemailArchiveContract.VoicemailArchive.DATE + " LONG,"
                + VoicemailArchiveContract.VoicemailArchive.DURATION + " LONG,"
                + VoicemailArchiveContract.VoicemailArchive.MIME_TYPE + " TEXT,"
                + VoicemailArchiveContract.VoicemailArchive.COUNTRY_ISO + " TEXT,"
                + VoicemailArchiveContract.VoicemailArchive._DATA + " TEXT,"
                + VoicemailArchiveContract.VoicemailArchive.GEOCODED_LOCATION + " TEXT,"
                + VoicemailArchiveContract.VoicemailArchive.CACHED_NAME + " TEXT,"
                + VoicemailArchiveContract.VoicemailArchive.CACHED_NUMBER_TYPE + " INTEGER,"
                + VoicemailArchiveContract.VoicemailArchive.CACHED_NUMBER_LABEL + " TEXT,"
                + VoicemailArchiveContract.VoicemailArchive.CACHED_LOOKUP_URI + " TEXT,"
                + VoicemailArchiveContract.VoicemailArchive.CACHED_MATCHED_NUMBER + " TEXT,"
                + VoicemailArchiveContract.VoicemailArchive.CACHED_NORMALIZED_NUMBER + " TEXT,"
                + VoicemailArchiveContract.VoicemailArchive.CACHED_PHOTO_ID + " LONG,"
                + VoicemailArchiveContract.VoicemailArchive.CACHED_FORMATTED_NUMBER + " TEXT,"
                + VoicemailArchiveContract.VoicemailArchive.ARCHIVED + " INTEGER,"
                + VoicemailArchiveContract.VoicemailArchive.NUMBER_PRESENTATION + " INTEGER,"
                + VoicemailArchiveContract.VoicemailArchive.ACCOUNT_COMPONENT_NAME + " TEXT,"
                + VoicemailArchiveContract.VoicemailArchive.ACCOUNT_ID + " TEXT,"
                + VoicemailArchiveContract.VoicemailArchive.FEATURES + " INTEGER,"
                + VoicemailArchiveContract.VoicemailArchive.SERVER_ID + " INTEGER,"
                + VoicemailArchiveContract.VoicemailArchive.TRANSCRIPTION + " TEXT,"
                + VoicemailArchiveContract.VoicemailArchive.CACHED_PHOTO_URI + " TEXT"
                + ");");
    }
