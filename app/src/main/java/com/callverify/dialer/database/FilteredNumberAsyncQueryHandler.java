...
public class FilteredNumberAsyncQueryHandler extends AsyncQueryHandler {
    ...
    public final void incrementFilteredCount(Integer id) {
        ...
        startUpdate(NO_TOKEN, null,
                ContentUris.withAppendedId(FilteredNumberContract.FilteredNumber.CONTENT_URI_INCREMENT_FILTERED_COUNT, id),
                null, null, null);
    }
    ...
    public void hasBlockedNumbers(final OnHasBlockedNumbersListener listener) {
        startQuery(NO_TOKEN,
                ...
                FilteredNumberCompat.useNewFiltering() ? null : FilteredNumberContract.FilteredNumberColumns.TYPE
        ...
        startQuery(NO_TOKEN,
                new Listener() {
                    ...
                    protected void onQueryComplete(int token, Object cookie, Cursor cursor) {
                        ...
                        if (!FilteredNumberCompat.useNewFiltering()
                                && cursor.getInt(cursor.getColumnIndex(FilteredNumberContract.FilteredNumberColumns.TYPE))
                                != FilteredNumberContract.FilteredNumberTypes.BLOCKED_NUMBER) {
                            listener.onCheckComplete(null);
                            return;
                        }
                        listener.onCheckComplete(
                                cursor.getInt(cursor.getColumnIndex(FilteredNumberContract.FilteredNumberColumns._ID)));
                    }
                },
                FilteredNumberCompat.getContentUri(null),
