...
public class BlockedNumbersAdapter extends NumbersAdapter {
    ...
    public void bindView(View view, final Context context, Cursor cursor) {
        ...
        final Integer id = cursor.getInt(cursor.getColumnIndex(FilteredNumberContract.FilteredNumberColumns._ID));
        final String countryIso = cursor.getString(cursor.getColumnIndex(
                FilteredNumberContract.FilteredNumberColumns.COUNTRY_ISO));
        final String number = cursor.getString(cursor.getColumnIndex(FilteredNumberContract.FilteredNumberColumns.NUMBER));
