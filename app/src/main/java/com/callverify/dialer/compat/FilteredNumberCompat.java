...
package com.callverify.dialer.compat;
...
import com.callverify.contacts.common.compat.TelecomManagerUtil;
import com.callverify.contacts.common.testing.NeededForTesting;
import com.callverify.dialer.DialerApplication;
import com.callverify.dialer.database.FilteredNumberAsyncQueryHandler;
import com.callverify.dialer.database.FilteredNumberAsyncQueryHandler.OnCheckBlockedListener;
import com.callverify.dialer.database.FilteredNumberContract;
import com.callverify.dialer.filterednumber.BlockNumberDialogFragment;
import com.callverify.dialer.filterednumber.BlockedNumbersMigrator;
import com.callverify.dialer.filterednumber.BlockedNumbersSettingsActivity;
import com.callverify.dialer.filterednumber.MigrateBlockedNumbersDialogFragment;
...
public class FilteredNumberCompat {
    ...
    public static String getIdColumnName() {
        return useNewFiltering() ? BlockedNumbersSdkCompat._ID : FilteredNumberContract.FilteredNumberColumns._ID;
    }
    ...
    public static String getTypeColumnName() {
        return useNewFiltering() ? null : FilteredNumberContract.FilteredNumberColumns.TYPE;
    }
    ...
    public static String getSourceColumnName() {
        return useNewFiltering() ? null : FilteredNumberContract.FilteredNumberColumns.SOURCE;
    }
    ...
    public static String getCountryIsoColumnName() {
        return useNewFiltering() ? null : FilteredNumberContract.FilteredNumberColumns.COUNTRY_ISO;
    }
    ...
    public static ContentValues newBlockNumberContentValues(String number,
        ...
        if (!useNewFiltering()) {
            ...
            contentValues.put(getTypeColumnName(), FilteredNumberContract.FilteredNumberTypes.BLOCKED_NUMBER);
            contentValues.put(getSourceColumnName(), FilteredNumberContract.FilteredNumberSources.USER);
        }
     ...
     * @param callback        (optional) The {@link BlockNumberDialogFragment.Callback} to call when the block or unblock operation
     *                        is complete.
     */
    public static void showBlockNumberDialogFlow(final ContentResolver contentResolver,
                                                 ...
                                                 final FragmentManager fragmentManager, @Nullable final BlockNumberDialogFragment.Callback callback) {
