...
import com.callverify.common.io.MoreCloseables;
import com.callverify.contacts.common.compat.CompatUtils;
import com.callverify.contacts.common.compat.TelephonyManagerCompat;
import com.callverify.contacts.common.database.NoNullCursorAsyncQueryHandler;
import com.callverify.contacts.common.util.ContactDisplayUtils;
import com.callverify.contacts.common.widget.SelectPhoneAccountDialogFragment;
        ...
        if ((len > 1) && (len < 5) && (input.endsWith("#"))) {
            try {
                ...
                if (subscriptionAccountHandles.size() <= 1 || hasUserSelectedDefault) {
                    ...
                    SelectPhoneAccountDialogFragment.SelectPhoneAccountListener callback = new HandleAdnEntryAccountSelectedCallback(
    ...
    static boolean handlePinEntry(final Context context, final String input) {
        if ((input.startsWith("**04") || input.startsWith("**05")) && input.endsWith("#")) {
            ...
            if (subscriptionAccountHandles.size() <= 1 || hasUserSelectedDefault) {
                ...
                SelectPhoneAccountDialogFragment.SelectPhoneAccountListener listener =
