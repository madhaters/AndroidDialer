...
package com.callverify.contacts.common.model;
...
import com.callverify.contacts.common.ContactsUtils;
import com.callverify.contacts.common.model.account.AccountType;
import com.callverify.contacts.common.model.account.GoogleAccountType;
import com.callverify.contacts.common.model.dataitem.DataKind;
import com.callverify.contacts.common.model.dataitem.PhoneDataItem;
import com.callverify.contacts.common.model.dataitem.StructuredNameDataItem;
import com.callverify.contacts.common.util.CommonDateUtils;
import com.callverify.contacts.common.util.DateUtils;
import com.callverify.contacts.common.util.NameConverter;
...
public class RawContactModifier {
     ...
     * list possible {@link AccountType.EditType} options available based on
     * {@link AccountType}.
     *
     * @param forceInclude     Always include this {@link AccountType.EditType} in the returned
     ...
     *                         {@link AccountType.EditType#secondary}.
     * @param typeCount        When provided, will be used for the frequency count of
     *                         each {@link AccountType.EditType}, otherwise built using
    ...
    /**
     * Count up the frequency that each {@link AccountType.EditType} appears in the given
     * {@link RawContactDelta}. The returned {@link SparseIntArray} maps from
     * {@link AccountType.EditType#rawValue} to counts, with the total overall count stored
    ...
    /**
     * Find the {@link AccountType.EditType} that describes the given
    ...
    /**
     * Find the {@link AccountType.EditType} that describes the given {@link ContentValues} row,
    ...
    /**
     * Find the {@link AccountType.EditType} that describes the given {@link Cursor} row,
     * assuming the given {@link DataKind} dictates the possible types.
     */
    ...
    /**
     * Find the {@link AccountType.EditType} with the given {@link AccountType.EditType#rawValue}.
     */
    ...
    /**
     * Return the precedence for the the given {@link AccountType.EditType#rawValue}, where
    ...
    /**
     * Find the best {@link AccountType.EditType} for a potential insert. The "best" is the
     ...
     * {@link RawContactDelta}. Tries using the best {@link AccountType.EditType} found using
    ...
    /**
     * Insert a new child of kind {@link DataKind} into the given
     * {@link RawContactDelta}, marked with the given {@link AccountType.EditType}.
     */
     ...
     * or no valid {@link AccountType.EditType} found.
     *
     * @param typeExtra   {@link Bundle} key that holds the incoming
     *                    {@link AccountType.EditType#rawValue} value.
