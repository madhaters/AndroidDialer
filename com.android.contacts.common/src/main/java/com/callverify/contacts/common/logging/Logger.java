 ...
 */
package com.callverify.contacts.common.logging;

import android.app.Activity;
import android.text.TextUtils;

import com.callverify.contacts.commonbind.ObjectFactory;
...
public abstract class Logger {
    ...
    public static void logScreenView(Activity activity, int screenType) {
        logScreenView(activity, screenType, ScreenEvent.ScreenType.UNKNOWN);
    }
    ...
    public static void logScreenView(Activity activity, int screenType, int previousScreenType) {
        ...
        String tag = ScreenEvent.ScreenType.getFriendlyName(previousScreenType);
